...
enum SHADERTYPE
{
    ...
    RTTYPE_RTREFLECTION,
#ifdef GGREDUCED
	CSTYPE_POSTPROCESS_RAIN, //PE: Test
	CSTYPE_POSTPROCESS_SNOW, //PE: Test
#endif
	PSTYPE_OBJECT_LOD,
	PSTYPE_OBJECT_TRANSPARENT_LOD,
	VSTYPE_OBJECT_LOD,
    SHADERTYPE_COUNT,
};
